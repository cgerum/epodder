...
/* callback used for sorting files in pure asci ordering */
static int
...
file_dlg_show()
{
   Evas_Object *bg, *bx, *lb, *li, *bt, *bx2, *fr, *fr0;
   ...
   elm_box_pack_end(bx2, bt);   evas_object_show(bt);
